    ...
    'app' => [
        ...
        'elements' => [
            ...
            [
                ...
                'class' => 'readOnly', // any class for input
    ...
    'email' => [
        ...
        'elements' => [
            [
                ...
                'class' => '', // any class for input
                'value' => 'admissions@sbup.edu.in', // default value if you want
            ],
            [
                'type'  => 'text', // input fields type
                'data'  => 'string', // data type, string, int, boolean
                'name'  => 'website', // unique name for field
                'label' => 'Website Url', // you know what label it is
                'rules' => 'required', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'www.biibpune.com', // default value if you want
            ],
        ...
        'elements' => [
            ...
            [
             ...
             [
                ...
                'label' => 'Whatsapp Number', // you know what label it is
                'rules' => 'required|nullable|max:120', // validation rule of laravel
                'class' => '', // any class for input
                'value' => '#', // default value if you want
            ],
        ],
