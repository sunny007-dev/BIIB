 ...
 * automatically to thumbnail image
 */
 if (!function_exists('youtube_format')) {

    /**
     * Format a string to Youtube.
     */
    function youtube_format($string)
    {
        $base_string = $string;

        $string= preg_split("/[=\/]/",$string);
        $string = $string[4];
        $collectionA = "https://img.youtube.com/vi/";
        $collectionB = $string;
        $collectionC = "/hqdefault.jpg";
        $string = sprintf("%s%s%s", $collectionA,$collectionB,$collectionC);
