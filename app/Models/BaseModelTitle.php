...
class BaseModelTitle extends Model implements HasMedia
{
    use SoftDeletes;
    ...
    public function setSlugAttribute($value)
    {
        ...
        if (empty($value)) {
            ...
            $this->attributes['slug'] = slug_format(trim($this->attributes['title']));
        }

  
    }

    public function setYoutubeThumbnail($value)
    {
        
        $this->attributes['thumbnail_url'] = slug_format(trim($value));

        if (empty($value)) {
         
            $this->attributes['thumbnail_url'] = slug_format($this->attributes['url']);
