...
namespace Modules\Sitemap\Http\Controllers\Backend;
...
use Modules\Sitemap\Http\Requests\Backend\SitemapRequest;
...
class SitemapController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->module_model = "Modules\Sitemap\Entities\Sitemap";
    }
    ...
    public function index()
    {
        ...
        return view(
            "sitemap::backend.$module_name.index_datatable",
    ...
    public function index_data()
    {
        ...
        $$module_name = $module_model::select(DB::raw('@rownum := 0 '))
                        ->select(DB::raw('@rownum :=  @rownum  + 1 AS rownum'),'id', 'title','categories','order','url','status', 'updated_at');
    ...
    public function create()
    {
        ...
        return view(
            "sitemap::backend.$module_name.create",
    ...
    public function show($id)
    {
        ...
        return view(
            "sitemap::backend.$module_name.show",
    ...
    public function edit($id)
    {
        ...
        return view(
            "sitemap::backend.$module_name.edit",
    ...
    public function trashed()
    {
        ...
        return view(
            "sitemap::backend.$module_name.trash",
            compact('module_title', 'module_name', "$module_name", 'module_icon', 'module_name_singular', 'module_action')
        );
    }
