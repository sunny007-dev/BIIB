        ...
        <div class="flex flex-col lg:flex-grow sm:w-8/12 sm:pr-8">
            ...
            <div class="flex flex-row justify-between content-center items-center py-5">
                <p>
                    ...
                    <a href="{{route('frontend.categories.show', [encode_id($$module_name_singular->pages_category_id)])}}" class="m-2 p-2 bg-gray-100 rounded border-transparent border hover:border-gray-800 transition ease-out duration-300">{{$$module_name_singular->category_name}}</a>
                </p>
