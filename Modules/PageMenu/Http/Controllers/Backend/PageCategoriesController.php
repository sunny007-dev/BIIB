...
use Modules\PageMenu\Http\Requests\Backend\PageCategoriesRequest;
...
class PageCategoriesController extends Controller
{
    ...
    public function index_list(Request $request)
    {
        ...
        $query_data = $module_model::where('type','=','main_menu')->where('name', 'LIKE', "%$term%")->
       limit(7)->get();
    ...
    public function index_lists(Request $request)
    {
        ...
        $query_data = $module_model::where('type','=','sub_menu')->where('name', 'LIKE', "%$term%")->
       limit(7)->get();
    ...
    public function index_data()
    {
        ...
        $$module_name = $module_model::select(DB::raw('@rownum := 0 '))
                        ->select(DB::raw('@rownum :=  @rownum  + 1 AS rownum'),'id', 'name','type' ,'order','route', 'updated_at');
    ...
    public function store(PageCategoriesRequest $request)
    {
        ...
        $module_action = 'Store';
        $data = $request->all();
        $subPage = $module_model::where('id',$data['sub_page_of_id'])->get()->pluck('name');
      
        if(isEmpty($subPage))
        {
            $$module_name_singular = $module_model::create($data);
        }else{
            $data['sub_page_of'] = $subPage[0];
            $$module_name_singular = $module_model::create($data);
        }
    ...
    public function show($id)
    {
        ...
        $posts = $$module_name_singular->pages()->latest()->paginate();
     ...
     * @return Response
     */
    public function update(PageCategoriesRequest $request, $id)
    {
        $module_title = $this->module_title;
        $module_name = $this->module_name;
        $module_path = $this->module_path;
