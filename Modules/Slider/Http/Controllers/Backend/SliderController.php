...
use Modules\Slider\Http\Requests\Backend\SliderRequest;
...
class SliderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view(
            "slider::backend.$module_name.index_datatable",
    ...
    public function index_data()
    {
        ...
        $$module_name = $module_model::select(DB::raw('@rownum := 0 '))
                        ->select(DB::raw('@rownum :=  @rownum  + 1 AS rownum'),'id', 'title','year','order','image_1', 'status', 'updated_at');
    ...
    public function create()
    {
        ...
        return view(
            "slider::backend.$module_name.create",
    ...
    public function show($id)
    {
        ...
        return view(
            "slider::backend.$module_name.show",
    ...
    public function edit($id)
    {
        ...
        return view(
            "slider::backend.$module_name.edit",
    ...
    public function trashed()
    {
        ...
        return view(
            "slider::backend.$module_name.trash",
            compact('module_title', 'module_name', "$module_name", 'module_icon', 'module_name_singular', 'module_action')
        );
    }
