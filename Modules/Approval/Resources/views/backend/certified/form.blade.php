<div class="row mb-3">
    <div class="col-5">
        <div class="form-group">
            <?php
            $field_name = 'name';
            $field_lable = __("approval::$module_name.$field_name");
    ...
    <div class="col-4">
               <div class="form-group">
            <?php
            $field_name = 'certified_type_id';
            $field_lable = __("approval::$module_name.$field_name");
            $field_relation = "certifiedCategory";
            $field_placeholder = __("Select an option");
            $required = "required";
            $value = $certifiedCategory;
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.select2-category').select2({
            ...
            allowClear: true,
            ajax: {
                url: '{{route("backend.certifiedType.index_list")}}',
                dataType: 'json',
