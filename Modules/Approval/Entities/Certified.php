...
use Modules\Approval\Entities\Presenters\CertifiedPresenter;
...
class Certified extends BaseModel
{
    ...
    {
        return $this->belongsTo('Modules\Approval\Entities\CertifiedType');
    }


    public function setCategoryIdAttribute($value)
    {
        $this->attributes['certified_type_id'] = $value;

        try {
            $category = CertifiedType::findOrFail($value);
            $this->attributes['certified_type_name'] = $category->name;
        } catch (\Exception $e) {
            $this->attributes['certified_type_name'] = null;
        }
    }
