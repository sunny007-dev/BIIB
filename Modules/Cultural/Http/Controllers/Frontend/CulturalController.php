...
namespace Modules\Cultural\Http\Controllers\Frontend;
...
use Modules\Cultural\Http\Requests\Frontend\SliderRequest;
...
class CulturalController extends Controller
{
    ...
    {
        // Page Title
        $this->module_title = 'Cultural';

        // module name
        $this->module_name = 'cultural';

        // module icon
        $this->module_icon = 'fas fa-comments';

        // module model name, path
        $this->module_model = "Modules\Cultural\Entities\Cultural";
    }
    ...
    public function index()
    {
        ...
        return view(
            "cultural::frontend.$module_name.index",
