...
namespace Modules\BrochureLink\Http\Controllers\Frontend;
...
use Modules\BrochureLink\Http\Requests\Frontend\BrochureLinkRequest;
...
class BrochureController extends Controller
{
    ...
    {
        // Page Title
        $this->module_title = 'BrochureLink';
    ...
    public function index()
    {
        ...
        return view(
            "brochure::frontend.$module_name.index",
