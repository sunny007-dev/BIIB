...
namespace Modules\Founder\Http\Controllers\Backend;
...
use Modules\Founder\Http\Requests\Backend\FounderRequest;
...
class FounderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view(
            "founder::backend.$module_name.index_datatable",
    ...
    public function index_data()
    {
        ...
        $$module_name = $module_model::select(DB::raw('@rownum := 0 '))
                        ->select(DB::raw('@rownum :=  @rownum  + 1 AS rownum'),'id', 'title','content_1','featured_image', 'status', 'updated_at');
    ...
    public function create()
    {
        ...
        return view(
            "founder::backend.$module_name.create",
    ...
    public function show($id)
    {
        ...
        return view(
            "founder::backend.$module_name.show",
    ...
    public function edit($id)
    {
        ...
        return view(
            "founder::backend.$module_name.edit",
    ...
    public function trashed()
    {
        ...
        return view(
            "founder::backend.$module_name.trash",
            compact('module_title', 'module_name', "$module_name", 'module_icon', 'module_name_singular', 'module_action')
        );
    }
