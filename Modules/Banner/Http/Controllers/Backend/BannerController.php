...
use Modules\Banner\Http\Requests\Backend\BannerRequest;
...
class BannerController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->module_model = "Modules\Banner\Entities\Banner";
    }
    ...
    public function index()
    {
        ...
        return view(
            "banner::backend.$module_name.index_datatable",
    ...
    public function index_data()
    {
        ...
        $$module_name = $module_model::select(DB::raw('@rownum := 0 '))
                        ->select(DB::raw('@rownum :=  @rownum  + 1 AS rownum'),'id', 'title','content','featured_image', 'type','status', 'updated_at');
    ...
    public function create()
    {
        ...
        return view(
            "banner::backend.$module_name.create",
    ...
    public function show($id)
    {
        ...
        return view(
            "banner::backend.$module_name.show",
    ...
    public function edit($id)
    {
        ...
        return view(
            "banner::backend.$module_name.edit",
    ...
    public function trashed()
    {
        ...
        return view(
            "banner::backend.$module_name.trash",
            compact('module_title', 'module_name', "$module_name", 'module_icon', 'module_name_singular', 'module_action')
        );
    }
