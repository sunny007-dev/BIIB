...
use Modules\Gallery\Http\Requests\Backend\GalleryRequest;
...
class GalleryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view(
            "gallery::backend.$module_name.index_datatable",
    ...
    public function index_data()
    {
        ...
        $$module_name = $module_model::select(DB::raw('@rownum := 0 '))
                        ->select(DB::raw('@rownum :=  @rownum  + 1 AS rownum'),'id', 'title','type','featured_image', 'status', 'updated_at');
    ...
    public function create()
    {
        ...
        return view(
            "gallery::backend.$module_name.create",
    ...
    public function show($id)
    {
        ...
        return view(
            "gallery::backend.$module_name.show",
    ...
    public function edit($id)
    {
        ...
        return view(
            "gallery::backend.$module_name.edit",
    ...
    public function trashed()
    {
        ...
        return view(
            "gallery::backend.$module_name.trash",
            compact('module_title', 'module_name', "$module_name", 'module_icon', 'module_name_singular', 'module_action')
        );
    }
