...
use Modules\Course\Entities\Presenters\CoursePresenter;
use Spatie\Activitylog\LogOptions;
use Spatie\Activitylog\Traits\LogsActivity;

class Course extends BaseModelTitle
{
    use LogsActivity;
    use CoursePresenter;
    use SoftDeletes;
    ...
    // {
    //     return $this->belongsTo('Modules\Course\Entities\Course', 'parent_id');
    // }

    // /**
    //  * Purifiy Course field value.
    //  */
