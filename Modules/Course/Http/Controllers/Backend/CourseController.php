...
use Modules\Course\Http\Requests\Backend\CourseRequest;
...
class CourseController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // module name
        $this->module_name = 'course';

        // module icon
        $this->module_icon = 'fa fa-book';

        // module model name, path
        $this->module_model = "Modules\Course\Entities\Course";
    }
    ...
    public function index()
    {
        ...
        return view(
            "course::backend.$module_name.index_datatable",
    ...
    public function index_data()
    {
        ...
        $$module_name = $module_model::select(DB::raw('@rownum := 0 '))
                        ->select(DB::raw('@rownum :=  @rownum  + 1 AS rownum'),'id', 'title','duration','featured_image', 'status', 'updated_at');
    ...
    public function create()
    {
        ...
        return view(
            "course::backend.$module_name.create",
    ...
    public function show($id)
    {
        ...
        return view(
            "course::backend.$module_name.show",
    ...
    public function edit($id)
    {
        ...
        return view(
            "course::backend.$module_name.edit",
    ...
    public function trashed()
    {
        ...
        return view(
            "course::backend.$module_name.trash",
            compact('module_title', 'module_name', "$module_name", 'module_icon', 'module_name_singular', 'module_action')
        );
    }
