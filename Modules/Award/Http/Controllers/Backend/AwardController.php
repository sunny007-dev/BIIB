...
namespace Modules\Award\Http\Controllers\Backend;
...
use Modules\Award\Http\Requests\Backend\AwardRequest;
...
class AwardController extends Controller
{
    ...
    {
        // Page Title
        $this->module_title = 'Award & Ranking';

        // module name
        $this->module_name = 'award';

        // module icon
        $this->module_icon = 'fa fa-trophy';

        // module model name, path
        $this->module_model = "Modules\Award\Entities\Award";
    }
    ...
    public function index()
    {
        ...
        return view(
            "award::backend.$module_name.index_datatable",
    ...
    public function index_data()
    {
        ...
        $$module_name = $module_model::select(DB::raw('@rownum := 0 '))
                        ->select(DB::raw('@rownum :=  @rownum  + 1 AS rownum'),'id', 'title','year','issued_by', 'status', 'updated_at');
    ...
    public function create()
    {
        ...
        return view(
            "award::backend.$module_name.create",
    ...
    public function show($id)
    {
        ...
        return view(
            "award::backend.$module_name.show",
    ...
    public function edit($id)
    {
        ...
        return view(
            "award::backend.$module_name.edit",
    ...
    public function trashed()
    {
        ...
        return view(
            "award::backend.$module_name.trash",
            compact('module_title', 'module_name', "$module_name", 'module_icon', 'module_name_singular', 'module_action')
        );
    }
