...
namespace Modules\Loan\Http\Controllers\Frontend;
...
use Modules\Loan\Http\Requests\Frontend\LoanRequest;
...
class LoanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view(
            "loan::frontend.$module_name.index",
    ...
    public function show($id)
    {
        ...
        return view(
            "loan::frontend.$module_name.show",
