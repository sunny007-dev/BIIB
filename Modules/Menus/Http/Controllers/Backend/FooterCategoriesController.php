...
use Modules\Menus\Http\Requests\Backend\FooterCategoriesRequest;
...
class FooterCategoriesController extends Controller
{
    ...
    public function __construct()
    {
        ...
        // module name
        $this->module_name = 'footerCategories';

        // directory path of the module
        $this->module_path = 'footerCategories';

        // module icon
        $this->module_icon = 'fas fa-sitemap';

        // module model name, path
        $this->module_model = "Modules\Menus\Entities\FooterCategory";
    }
    ...
    public function index_data()
    {
        ...
        $$module_name = $module_model::select(DB::raw('@rownum := 0 '))
                        ->select(DB::raw('@rownum :=  @rownum  + 1 AS rownum'),'id', 'name', 'order','route', 'updated_at');
     ...
     * @return Response
     */
    public function store(FooterCategoriesRequest $request)
    {
        $module_title = $this->module_title;
        $module_name = $this->module_name;
        $module_path = $this->module_path;
    ...
    public function show($id)
    {
        ...
        $posts = $$module_name_singular->footer()->latest()->paginate();
     ...
     * @return Response
     */
    public function update(FooterCategoriesRequest $request, $id)
    {
        $module_title = $this->module_title;
        $module_name = $this->module_name;
        $module_path = $this->module_path;
