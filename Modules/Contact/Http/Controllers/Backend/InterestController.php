...
use Modules\Contact\Http\Requests\Backend\InterestRequest;
...
class InterestController extends Controller
{
    ...
    {
        // Page Title
        $this->module_title = 'Interest';

        // module name
        $this->module_name = 'interest';

        // module icon
        $this->module_icon = 'fas fa-Interest';

        // module model name, path
        $this->module_model = "Modules\Contact\Entities\Interest";
    }
    ...
    public function index()
    {
        ...
        return view(
            "contact::backend.$module_name.index_datatable",
    ...
    public function index_data()
    {
        ...
        $$module_name = $module_model::select(DB::raw('@rownum := 0 '))
                        ->select(DB::raw('@rownum :=  @rownum  + 1 AS rownum'),'id', 'name', 'status', 'updated_at');
    ...
    public function create()
    {
        ...
        return view(
            "contact::backend.$module_name.create",
    ...
    public function store(InterestRequest $request)
    {
        ...
        auth()->user()->notify(new NewInterestAdded($$module_name_singular));
    ...
    public function show($id)
    {
        ...
        return view(
            "contact::backend.$module_name.show",
    ...
    public function edit($id)
    {
        ...
        return view(
            "contact::backend.$module_name.edit",
    ...
    public function trashed()
    {
        ...
        return view(
            "contact::backend.$module_name.trash",
            compact('module_title', 'module_name', "$module_name", 'module_icon', 'module_name_singular', 'module_action')
        );
    }
    ...
    public function exportCSV() 
    {
        ...
        return Excel::download(new InterestExport, 'interest.xlsx');
    }
}
