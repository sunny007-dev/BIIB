...
use Modules\Contact\Http\Requests\Backend\EnquiryRequest;
...
class EnquiryController extends Controller
{
    ...
    public function index()
    {
        ...
        $$module_name = $module_model::where('type','=','enquiry')->paginate();
    ...
    public function index_data()
    {
        ...
        $$module_name = $module_model::select(DB::raw('@rownum := 0 '))
                        ->select(DB::raw('@rownum :=  @rownum  + 1 AS rownum'),'id', 'name', 'status', 'updated_at')->where('type','enquiry');
    ...
    public function store(EnquiryRequest $request)
    {
        ...
        auth()->user()->notify(new NewEnquiryAdded($$module_name_singular));
    ...
    public function exportCSV() 
    {
        ...
        return Excel::download(new EnquiryExport, 'enquiry.csv');
    }
}
