...
use Modules\Team\Entities\Presenters\FacultyPresenter;
...
class Faculty extends BaseModel
{
    ...
    {
        return $this->belongsTo('Modules\Team\Entities\Fcategory');
    }


    public function setCategoryIdAttribute($value)
    {
        $this->attributes['faculty_category_id'] = $value;

        try {
            $fcategory = Fcategory::findOrFail($value);
            $this->attributes['faculty_category_name'] = $fcategory->name;
        } catch (\Exception $e) {
            $this->attributes['faculty_category_name'] = null;
        }
    }
