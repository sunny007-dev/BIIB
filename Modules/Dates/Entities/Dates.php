...
namespace Modules\Dates\Entities;

use App\Models\BaseModelTitle;
use App\Models\User;
use Carbon\Carbon;
use Illuminate\Database\Eloquent\SoftDeletes;
use Modules\Dates\Entities\Presenters\DatesPresenter;
use Spatie\Activitylog\LogOptions;
use Spatie\Activitylog\Traits\LogsActivity;

class Dates extends BaseModelTitle
{
    use LogsActivity;
    use DatesPresenter;
    use SoftDeletes;
    ...
    // {
    //     return $this->belongsTo('Modules\Dates\Entities\Dates', 'parent_id');
    // }

    // /**
    //  * Purifiy Dates field value.
    //  */
