...
namespace Modules\Dates\Http\Controllers\Frontend;
...
use Modules\Dates\Http\Requests\Frontend\DatesRequest;
...
class DatesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view(
            "award::frontend.$module_name.index",
    ...
    public function show($id)
    {
        ...
        return view(
            "award::frontend.$module_name.show",
