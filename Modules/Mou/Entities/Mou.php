...
namespace Modules\Mou\Entities;

use App\Models\BaseModelTitle;
use App\Models\User;
use Carbon\Carbon;
use Illuminate\Database\Eloquent\SoftDeletes;
use Modules\Mou\Entities\Presenters\MouPresenter;
use Spatie\Activitylog\LogOptions;
use Spatie\Activitylog\Traits\LogsActivity;

class Mou extends BaseModelTitle
{
    use LogsActivity;
    use MouPresenter;
    use SoftDeletes;
    ...
    // {
    //     return $this->belongsTo('Modules\Mou\Entities\Mou', 'parent_id');
    // }

    // /**
    //  * Purifiy Mou field value.
    //  */
