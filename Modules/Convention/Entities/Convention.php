...
namespace Modules\Convention\Entities;

use App\Models\BaseModel;
use Carbon\Carbon;
use Illuminate\Database\Eloquent\SoftDeletes;
use Modules\Convention\Entities\Presenters\ConventionPresenter;
use Spatie\Activitylog\LogOptions;
use Spatie\Activitylog\Traits\LogsActivity;

class Convention extends BaseModel
{
    use LogsActivity;
    use ConventionPresenter;
    use SoftDeletes;
