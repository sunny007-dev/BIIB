...
namespace Modules\Lecture\Http\Controllers\Backend;
...
use Modules\Lecture\Http\Requests\Backend\LecturesRequest;
...
class LecturesController extends Controller
{
    ...
    {
        // Page Title
        $this->module_title = 'Lecture & Leadership Training';
    ...
    public function index()
    {
        ...
        return view(
            "lecture::backend.$module_name.index_datatable",
    ...
    public function index_data()
    {
        ...
        $$module_name = $module_model::select(DB::raw('@rownum := 0 '))
                        ->select(DB::raw('@rownum :=  @rownum  + 1 AS rownum'),'id', 'title','type','video_link', 'designation', 'company');
    ...
    public function create()
    {
        ...
        Log::info(label_case($module_title.' '.$module_action).' | User:'.Auth::user()->name.'(ID:'.Auth::user()->id.')');
         $counting= [];
        return view(
            "lecture::backend.$module_name.create",
    ...
    public function show($id)
    {
        ...
        return view(
            "lecture::backend.$module_name.show",
    ...
    public function edit($id)
    {
        ...
        return view(
            "lecture::backend.$module_name.edit",
    ...
    public function trashed()
    {
        ...
        return view(
            "lecture::backend.$module_name.trash",
            compact('module_title', 'module_name', "$module_name", 'module_icon', 'module_name_singular', 'module_action')
        );
    }
