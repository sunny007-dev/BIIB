...
use Modules\Kpi\Entities\Presenters\KpiPresenter;
use Spatie\Activitylog\LogOptions;
use Spatie\Activitylog\Traits\LogsActivity;

class Kpi extends BaseModelTitle
{
    use LogsActivity;
    use KpiPresenter;
    use SoftDeletes;
    ...
    // {
    //     return $this->belongsTo('Modules\Kpi\Entities\Kpi', 'parent_id');
    // }

    // /**
    //  * Purifiy Kpi field value.
    //  */
