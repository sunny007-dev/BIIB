...
use Modules\News\Entities\Presenters\NewsPresenter;
use Spatie\Activitylog\LogOptions;
use Spatie\Activitylog\Traits\LogsActivity;

class News extends BaseModelTitle
{
    use LogsActivity;
    use NewsPresenter;
    use SoftDeletes;
    ...
    // {
    //     return $this->belongsTo('Modules\News\Entities\News', 'parent_id');
    // }

    // /**
    //  * Purifiy News field value.
    //  */
