...
<div class="row mb-3">
    <div class="col-6 col-md-6">
         <div class="form-group">
            <?php
            $field_name = 'discipline_committee';
            $field_lable = label_case($field_name);
            $field_placeholder = $field_lable;
            $required = "";
            ?>
    ...
    <div class="col-6 col-md-6">
        <div class="form-group">
            <?php
            $field_name = 'placement_committee';
            $field_lable = label_case($field_name);
            $field_placeholder = $field_lable;
            $required = "";
            ?>
...
<div class="row mb-3">
    ...
    <div class="col-6 col-md-6">
        <div class="form-group">
            <?php
            $field_name = 'corporate_relations_committee';
            $field_lable = label_case($field_name);
            $field_placeholder = $field_lable;
            $required = "";
            ?>
