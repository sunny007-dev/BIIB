    ...
    <div class="container">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-xl-4 col-lg-3">
                                <div class="facultyImg mb-3" style="background-image: url('{{ $results[0]->featured_image }}')"></div>
                            </div>
                            <div class="col-xl-8 col-lg-9 align-self-center position-relative">
                                <h4 class="facultyTitle">{{$results[0]->name}}</h4>
                                <p class="designation">{{$results[0]->designation}}</p>
                                <p class="text-muted">Full time faculty</p>
                                @if($results[0]->linkedin_url)
                                    <a class="linkedInDetail" href="{{ $results[0]->linkedin_url ? $results[0]->linkedin_url : '#' }}" target="{{$results[0]->linkedin_url ? '_blank' : '_self'}}"><i class="fab fa-linkedin fa-3x"></i></a>
                                @endif
                            </div>
                                    ...
                                    <div class="tab-pane fade" id="nav-three" role="tabpanel" aria-labelledby="nav-tab-three" tabindex="0">
                                        @foreach($research as $data) 
                                            ...
                                            <div class="sortingList">
                                                <div style="overflow:hidden">{!! $data->research_papers !!}</div>
                                            </div>
                                            @else
                                                <p>No Data Found</p>
                                            @endif
        ...
        <div class="row my-4 g-xl-3 g-lg-3 g-md-3 relatedFaculty m-0">
            <div class="col-12 my-xl-5 my-lg-5 my-md-4 my-sm-4 my-4">
                <h6 class="main-heading text-capitalize mb-0 text-center">Leadership</h6>
            </div>
