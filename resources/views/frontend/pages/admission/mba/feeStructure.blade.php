...
<div class="admissionpage  py-xl-5 py-lg-5 py-md-4 py-sm-4 py-4" id="admissionpage">
    <div class="container">
        <div class="row bg-white m-0">
            @foreach($mbaFeeStructure as $data)
                ...
                <div class="col-xl-12 my-2">
                    <h4 class="pagesHeading headingColor text-capitalize py-3 mb-0 text-xl-start text-lg-start text-md-start text-center">{{ $data->content_heading_1 }}</h4>
                </div>
                <div class="col-xl-12">
                    <div class="sortingList">
                        <div style="overflow-x:auto">{!! $data->content_1 !!}</div>
                    </div>
                </div>
            @endforeach
        </div>
