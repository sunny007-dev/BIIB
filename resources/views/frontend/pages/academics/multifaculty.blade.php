...
<div class="facultyPage py-xl-5 py-lg-5 py-md-4 py-sm-4 py-4" id="facultypage">
    <div class="container">
        <div class="row bg-white m-0">
            <div class="col-xl-12">
                <img class="w-100" src="{{asset('img/faculty/multi-development-faculty.jpg')}}" alt="faculty Img">
            </div>
            <div class="col-xl-12 my-2">
                <h4 class="pagesHeading text-capitalize py-3 mb-0 text-xl-start text-lg-start text-md-start text-center">Multi Development Personality Faculty</h4>
        ...
        <div class="row my-4 g-xl-3 g-lg-3 g-md-3 bg-white justify-content-center m-0">
            @foreach($module_name_multisingular as $data)
